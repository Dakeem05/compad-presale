export default defineNitroPlugin((nitroApp) => {
    nitroApp.hooks.hook('render:html', (html, { event }) => {
      ...
      html.head.push(`<meta property="og:url" content="https://compad-presale.vercel.app/" />`);
      ...
      html.head.push(`<meta property="og:image" content="https://pbs.twimg.com/profile_images/1685353964450004993/7q2iSxcW_400x400.jpg" />`);
